...
\item[Logical Centralization] \hfill \\ A Custos server should appear
  ...
  forgo truly global access in favor of to operating a Custos server
...
Second, if a user is unwilling to trust a single Custos provider, she
...
%%  LocalWords:  dm Plutus LastPass iCloud's

...
encryption-related use cases, the secretes Custos is storing are
private encryption keys, not any actual user data directly. Forgoing
the encryption-related use cases for a moment, Custos's secret store
...
the storage of encryption keys as in the prior use cases.
